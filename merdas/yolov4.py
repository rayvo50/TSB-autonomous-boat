...
class Detector():
    ...
    def __init__(self, image_pub, cloud_pub, CONFIDENCE_THRESHOLD=0.2, NMS_THRESHOLD=0.4):
        ...
        weights = '/home/zepedrofig/catkin_ws/src/buoy_detect/scripts/our_net.weights'
        cfg = '/home/zepedrofig/catkin_ws/src/buoy_detect/scripts/our_net.cfg'
...
def main(args):
    rospy.init_node('ai_vision', anonymous=True)
    rospy.loginfo('Running w/ Python version: ' + sys.version)
